...
p_grid_hist <- plot_grid(plotlist = list(p_hist_smoke_case, p_hist_smoke_control, p_hist_alc_case, p_hist_alc_control), 
                         labels = c("V1", "V2", "V3", "V4"), label_size = 12, nrow = 2, hjust = -0.25)